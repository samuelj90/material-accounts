...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.dashboardWidgetInfos = [
      { title: 'Days Income', styles: { background: 'linear-gradient(60deg,#66bb6a,#43a047)' }, amount: 500 },
      { title: 'Days Expense', styles: { background: 'linear-gradient(60deg,#ec407a,#d81b60)' }, amount: 5500 },
      { title: 'Months Income', styles: { background: 'linear-gradient(60deg,#0ba360,#3cba92)' }, amount: 55500 },
      { title: 'Months Expense', styles: { background: 'linear-gradient(60deg,#ff0844,#ffb199)' }, amount: 54500 },
      { title: 'Years Income', styles: { background: 'linear-gradient(60deg,#00e3ae,#abecd6)' }, amount: 55500 },
      { title: 'Years Expense', styles: { background: 'linear-gradient(60deg,#f5576c,#f093fb)' }, amount: 54500 }
    ];
